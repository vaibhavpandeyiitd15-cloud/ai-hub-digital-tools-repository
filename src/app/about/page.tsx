...
export const metadata = {
  ...
  description:
    "How Desire Lab evolved from the Agile Innovation Hub and AI Hub 2.0 — same tools, organised for Packaging Lab and Formulation Lab in Mumbai and Bangalore.",
};
